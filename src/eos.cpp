...
int short_EOS_table::write(const char *path)
{
  ...
  dataset = H5Dcreate2(file, "sigma_scattering_nuclei_nu", H5T_NATIVE_DOUBLE, dataspace, 
                          H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
  H5Dwrite(dataset, H5T_NATIVE_DOUBLE, H5S_ALL, H5S_ALL, H5P_DEFAULT, this->scattering_xs_nu_eos);
  H5Dclose (dataset);

  dataset = H5Dcreate2(file, "sigma_scattering_nuclei_nu_bar", H5T_NATIVE_DOUBLE, dataspace, 
                          H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
  H5Dwrite(dataset, H5T_NATIVE_DOUBLE, H5S_ALL, H5S_ALL, H5P_DEFAULT, this->scattering_xs_nu_bar_eos);
  H5Dclose (dataset);

  dataset = H5Dcreate2(file, "sigma_scattering_nuclei_nu_x", H5T_NATIVE_DOUBLE, dataspace, 
                          H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
